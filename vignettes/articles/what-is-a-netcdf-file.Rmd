...
We use the program PyNcView for viewing netCDF files. PyNcView is a cross-platform NetCDF viewer written in Python. It provides an easy-to-use graphical user interface to the creation of animations and publication-quality figures. It is free to download from SourceForge [here](https://github.com/BoldingBruggeman/pyncview/releases/).
