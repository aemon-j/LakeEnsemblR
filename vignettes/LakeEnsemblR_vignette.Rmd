...
LakeEnsemblR includes some tools for automatic model calibration which are included in the `cali_ensemble()` function. The function profides three methods:
 ...
 - methood "LHC": Lathin hypercube calibration
...
calibration:                    # Calibration section
   met:                         # Meteo scaling parameter
      wind_speed:			          # Wind speed scaling
         lower: 0.5			        # lower bound for wind speed scaline
         upper: 2			          # upper bound for wind speed scaline
         initial: 1			        # initial value for wind speed scaline
         log: false			        # log transform scaling factor
      swr:			       	        # shortwave radiation scaling
         lower: 0.5			        # lower bound for shortwave radiation scaline
         upper: 1.5			        # upper bound for shortwave radiation scaline
         initial: 1			        # initial value for shortwave radiation scaline
         log: false			        # log transform scaling factor
...
cali_ensemble(config_file, model = c("GLM", "GOTM", "FLake", "MyLake", "Simstrat"),
              cmethod = "modFir", out_f = "calibration", method = "Nelder-Mead")
